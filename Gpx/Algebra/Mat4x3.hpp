...
struct mat4x3_data
{
    mat4x3_data(const vec3_data& vc3_1, const vec3_data& vc3_2, const vec3_data& vc3_3, const vec3_data& vc3_4) :
...
public:
    ...
    explicit mat4x3(vec3 vc3_1 = vec3(), vec3 vc3_2 = vec3(), vec3 vc3_3 = vec3(), vec3 vc3_4 = vec3());

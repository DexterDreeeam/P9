...
_INLINE_ mat2x3::mat2x3(vec3 vc3_1, vec3 vc3_2) :
    _data(vc3_1._data, vc3_2._data)
{
}

_INLINE_ mat2x3::mat2x3(const mat2x3& rhs) :
    _data(rhs._data)
{
}

_INLINE_ mat2x3& mat2x3::operator =(const mat2x3& rhs)
{
    _data = rhs._data;
    return *this;
}

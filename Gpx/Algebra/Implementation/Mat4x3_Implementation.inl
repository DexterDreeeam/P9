...
mat4x3::mat4x3(vec3 vc3_1, vec3 vc3_2, vec3 vc3_3, vec3 vc3_4) :
    _data(vc3_1._data, vc3_2._data, vc3_3._data, vc3_4._data)
{
}

mat4x3::mat4x3(const mat4x3& rhs) :
    _data(rhs._data)
{
}
...
vec3 mat4x3::r1() const
{
    return _data._r1;
}

vec3 mat4x3::r2() const
{
    return _data._r2;
}

vec3 mat4x3::r3() const
{
    return _data._r3;
}

vec3 mat4x3::r4() const
{
    return _data._r4;
}

vec4 mat4x3::c1() const
{
    return vec4(
        _data._r1._x,
        _data._r2._x,

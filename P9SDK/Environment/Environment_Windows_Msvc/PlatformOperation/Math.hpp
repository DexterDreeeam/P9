...
#define _power(x,exp)                     ( WindowsMsvcNs::pow(x,exp) )
...
#define _tan_radian(x)                    WindowsMsvcNs::tan(x)
#define _tan_degree(x)                    WindowsMsvcNs::tan(degree_radian(x))
#define _sin_radian(x)                    WindowsMsvcNs::sin(x)
#define _sin_degree(x)                    WindowsMsvcNs::sin(degree_radian(x))
#define _cos_radian(x)                    WindowsMsvcNs::cos(x)
#define _cos_degree(x)                    WindowsMsvcNs::cos(degree_radian(x))

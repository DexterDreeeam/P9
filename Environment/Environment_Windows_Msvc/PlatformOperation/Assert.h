...
#define assert(exp)           WindowsMsvcNs::p9_assert(exp, #exp, __FUNCTION__, __LINE__)
#define assert_info(exp,info) WindowsMsvcNs::p9_assert(exp, #exp, info, __FUNCTION__, __LINE__)

...
namespace Dxt
{
    ...
    private:
        ...
        static WindowsMsvcNs::LRESULT CALLBACK MessageCb(
            WindowsMsvcNs::HWND hWnd,
            WindowsMsvcNs::UINT msg,
            WindowsMsvcNs::WPARAM wp,
            WindowsMsvcNs::LPARAM lp)
        {
            using namespace WindowsMsvcNs;
    ...
    private:
        ...
        WindowsMsvcNs::HMODULE           m_module;
        WindowsMsvcNs::HWND              m_handle;
        WindowsMsvcNs::WNDCLASS          m_window_class;
        thrd                          m_execute;
